...
class PatientTestStub {

    static Patient randomPatientForTenant(String tenantId) {
        return randomPatientForTenantWithName(tenantId, randomPatientName());
    }

    static Patient randomPatientForTenantWithName(String tenantId, PatientName patientName) {
    ...
    static List<Patient> generateNumberOfPatientsForTenantWithSameName(int numberOfPatients, String tenantId) {
        return generateNumberOfPatientsForTenant(numberOfPatients, tenantId, true);
    }

    static List<Patient> generateNumberOfPatientsForTenantWithRandomName(int numberOfPatients, String tenantId) {
